...
function validateKeys(object, expectedKeys) {
 ...
 return (objectKeys.filter(key => expectedKeys.includes(key)).length === expectedKeys.length) ? true : false;
  ...
  // if (objectKeys.length === numValidKeys && expectedKeys.length === numValidKeys) {
  //   return true;
  // } else {
  //   return false;
  // }
